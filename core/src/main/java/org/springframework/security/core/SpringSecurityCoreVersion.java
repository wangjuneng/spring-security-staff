...
public class SpringSecurityCoreVersion {
    ...
    /**
     * Global Serialization value for Spring Security classes. N.B. Classes are not intended to be serializable between
     * different versions. See SEC-1709 for why we still need a serial version.
     */
