 ...
 * <p>
 * A <code>GrantedAuthority</code> must either represent itself as a <code>String</code> or be specifically supported by
 * an {@link AccessDecisionManager}.
 *
 * @author Ben Alex
 */
public interface GrantedAuthority extends Serializable {
    /**
     * If the <code>GrantedAuthority</code> can be represented as a <code>String</code> and that <code>String</code> is
     * sufficient in precision to be relied upon for an access control decision by an {@link AccessDecisionManager} (or
