 ...
 * scratch.
 * <p>
 * {@code equals} and {@code hashcode} implementations are based on the {@code username} property only, as the intention
 * is that lookups of the same user principal object (in a user registry, for example) will match where the objects
 * represent the same user, not just when all the properties (authorities, password for example) are the same.
 * <p>
 * Note that this implementation is not immutable. It implements the {@code CredentialsContainer} interface, in order to
 * allow the password to be erased after authentication. This may cause side-effects if you are storing instances
...
public class User implements UserDetails, CredentialsContainer {
    ...
    public static class UserBuilder {
         ...
         * @return the {@link UserBuilder} for method chaining (i.e. to populate additional attributes for this user)
         */
        ...
        /**
         * Encodes the current password (if non-null) and any future passwords supplied to {@link #password(String)}.
         *
         ...
         * prefixes each entry with "ROLE_". This means the following: <code>
         ...
         * Populates the authorities. This attribute is required.
         *
         * @param authorities the authorities for this user (i.e. ROLE_USER, ROLE_ADMIN, etc). Cannot be null, or
         *            contain null values
         * @return the {@link UserBuilder} for method chaining (i.e. to populate additional attributes for this user)
         * @see #roles(String...)
         */
