...
public class SecurityContextHolder {
    ...
    /**
     * Changes the preferred strategy. Do <em>NOT</em> call this method more than once for a given JVM, as it will
     * re-initialize the strategy and adversely affect any existing threads using the old strategy.
     *
