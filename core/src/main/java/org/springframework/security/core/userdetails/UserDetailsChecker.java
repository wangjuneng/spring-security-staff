 ...
 * raising an exception if the information cannot be used (for example if the user account is locked or disabled), but a
 * custom implementation could perform any checks it wished.
 * <p>
