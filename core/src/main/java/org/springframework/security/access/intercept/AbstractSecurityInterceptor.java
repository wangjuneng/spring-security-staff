...
public abstract class AbstractSecurityInterceptor implements InitializingBean, ApplicationEventPublisherAware,
    ...
    /**
     * Indicates the type of secure objects the subclass will be presenting to the abstract parent for processing. This
     * is used to ensure collaborators wired to the {@code AbstractSecurityInterceptor} all support the indicated secure
     * object class.
     *
     ...
     * {@link Authentication#isAuthenticated()} property. Defaults to <code>false</code>, meaning by default the
     ...
     *            value of <code>Authentication.isAuthenticated()</code> and always re-authenticate the request
    ...
    /**
     * Only {@code AuthorizationFailureEvent} will be published. If you set this property to {@code true},
     * {@code AuthorizedEvent}s will also be published.
     *
    ...
    /**
     * By rejecting public invocations (and setting this property to <tt>true</tt>), essentially you are ensuring that
     * every secure object invocation advised by <code>AbstractSecurityInterceptor</code> has a configuration attribute
     * defined. This is useful to ensure a "fail safe" mode where undeclared secure objects will be rejected and
     * configuration omissions detected early. An <tt>IllegalArgumentException</tt> will be thrown by the
     * <tt>AbstractSecurityInterceptor</tt> if you set this property to <tt>true</tt> and an attempt is made to invoke a
     * secure object that has no configuration attributes.
     *
