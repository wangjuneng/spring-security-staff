 ...
 * <p>
 * This class is the preferred implementation of {@link MethodSecurityMetadataSource} for XML-based definition of method
 * security metadata. To assist in XML-based definition, wildcard support is provided.
 * </p>
 *
 * @author Ben Alex
 * @since 2.0
 */
public class MapBasedMethodSecurityMetadataSource extends AbstractFallbackMethodSecurityMetadataSource implements
    BeanClassLoaderAware {

    private ClassLoader beanClassLoader = ClassUtils.getDefaultClassLoader();

    /** Map from RegisteredMethod to ConfigAttribute list */
    protected final Map<RegisteredMethod, List<ConfigAttribute>> methodMap = new HashMap<MapBasedMethodSecurityMetadataSource.RegisteredMethod, List<ConfigAttribute>>();

    /** Map from RegisteredMethod to name pattern used for registration */
    private final Map<RegisteredMethod, String> nameMap = new HashMap<MapBasedMethodSecurityMetadataSource.RegisteredMethod, String>();
    ...
    /**
     * Stores both the Java Method as well as the Class we obtained the Method from. This is necessary because Method
     * only provides us access to the declaring class. It doesn't provide a way for us to introspect which Class the
     * Method was registered against. If a given Class inherits and redeclares a method (i.e. calls super();) the
     * registered Class and declaring Class are the same. If a given class merely inherits but does not redeclare a
     * method, the registered Class will be the Class we're invoking against and the Method will provide details of the
     * declared class.
     */
