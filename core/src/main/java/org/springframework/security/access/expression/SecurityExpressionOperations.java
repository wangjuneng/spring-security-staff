...
public interface SecurityExpressionOperations {
     ...
     * </p>
     * <p>
     * This is similar to {@link #hasAuthority(String)} except that this method implies that the String passed in is a
     * role. For example, if "USER" is passed in the implementation may convert it to use "ROLE_USER" instead. The way
     * in which the role is converted may depend on the implementation settings.
     * </p>
     *
     ...
     * </p>
     * <p>
     * This is a similar to hasAnyAuthority except that this method implies that the String passed in is a role. For
     * example, if "USER" is passed in the implementation may convert it to use "ROLE_USER" instead. The way in which
     * the role is converted may depend on the implementation settings.
     * </p>
     *
    ...
    /**
     * Determines if the {@link #getAuthentication()} has permission to access the domain object with a given id, type,
     * and permission.
     * 
