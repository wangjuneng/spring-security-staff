...
public abstract class AbstractSecurityExpressionHandler<T> implements SecurityExpressionHandler<T>,
    ...
    /**
     * Invokes the internal template methods to create {@code StandardEvaluationContext} and
     * {@code SecurityExpressionRoot} objects.
     *
     ...
     * <p>
     * The returned object will have a {@code SecurityExpressionRootPropertyAccessor} added, allowing beans in the
     * {@code ApplicationContext} to be accessed via expression properties.
     *
     * @param authentication the current authentication object
     * @param invocation the invocation (filter, method, channel)
