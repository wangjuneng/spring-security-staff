...
public class RoleHierarchyImpl implements RoleHierarchy {
    ...
    /**
     * rolesReachableInOneOrMoreStepsMap is a Map that under the key of a specific role name contains a set of all roles
     * reachable from this role in 1 or more steps
     */
     ...
     * calculated in O(1) time). During pre-calculation, cycles in role hierarchy are detected and will cause a
     ...
     * roles reachable in one or more steps. (Or throw a CycleInRoleHierarchyException if a cycle in the role hierarchy
