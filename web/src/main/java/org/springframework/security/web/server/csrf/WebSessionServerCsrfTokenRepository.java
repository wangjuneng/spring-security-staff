...
public class WebSessionServerCsrfTokenRepository implements ServerCsrfTokenRepository {
    ...
    public Mono<CsrfToken> generateToken(ServerWebExchange exchange) {
        return exchange.getSession().map(WebSession::getAttributes).map(this::createCsrfToken);
    }
    ...
    public Mono<CsrfToken> saveToken(ServerWebExchange exchange, CsrfToken token) {
        ...
        return exchange.getSession().map(WebSession::getAttributes).flatMap(attrs -> save(attrs, token));
    }
