...
public abstract class SaveContextOnUpdateOrErrorResponseWrapper extends OnCommittedResponseWrapper {
     ...
     * @param disableUrlRewriting turns the URL encoding methods into null operations, preventing the use of URL
     *            rewriting to add the session identifier as a URL parameter.
     */
    ...
    /**
     * Invoke this method to disable automatic saving of the {@link SecurityContext} when the
     * {@link HttpServletResponse} is committed. This can be useful in the event that Async Web Requests are made which
     * may no longer contain the {@link SecurityContext} on it.
     */
