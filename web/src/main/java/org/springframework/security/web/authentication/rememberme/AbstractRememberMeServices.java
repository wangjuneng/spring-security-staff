...
/**
 * <Description>Base class for RememberMeServices implementations. <br>
 * 
 * @author wang.jun<br>
 * @version 1.0<br>
 * @taskId <br>
 * @CreateDate 2018年2月18日 <br>
 * @since V7.3<br>
 * @see org.springframework.security.web.authentication.rememberme <br>
 */
public abstract class AbstractRememberMeServices implements RememberMeServices, InitializingBean, LogoutHandler {
    ...
    /**
     * Called from autoLogin to process the submitted persistent login cookie. Subclasses should validate the cookie and
     * perform any additional management required.
     *
     ...
     * @throws RememberMeAuthenticationException if the cookie is invalid or the login is invalid for some other reason.
     * @throws UsernameNotFoundException if the user account corresponding to the login cookie couldn't be found (for
     *             example if the user has been removed from the system).
     */
    ...
    /**
     * Locates the Spring Security remember me cookie in the request and returns its value. The cookie is searched for
     * by name and also by matching the context path to the cookie path.
     *
