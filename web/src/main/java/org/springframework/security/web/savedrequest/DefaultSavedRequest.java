 ...
 * and {@link org.springframework.security.web.savedrequest.SavedRequestAwareWrapper} to reproduce the request after
 * successful authentication. An instance of this class is stored at the time of an authentication exception by
 * {@link org.springframework.security.web.access.ExceptionTranslationFilter}.
 * <p>
 * <em>IMPLEMENTATION NOTE</em>: It is assumed that this object is accessed only from the context of a single thread, so
...
public class DefaultSavedRequest implements SavedRequest {
    ...
    public DefaultSavedRequest(HttpServletRequest request, PortResolver portResolver) {
        ...
        while (names.hasMoreElements()) {
            ...
            // Skip If-Modified-Since and If-None-Match header.
    ...
    private void addParameters(Map<String, String[]> parameters) {
        if (!ObjectUtils.isEmpty(parameters)) {
            for (String parameterName : parameters.keySet()) {
                Object paramValues = parameters.get(parameterName);
                if (paramValues instanceof String[]) {
                    this.addParameters(parameterName, (String[]) paramValues);
                }
                else {
    ...
    private void addParameters(String parameterName, String[] paramValues) {
        parameters.put(parameterName, paramValues);
    ...
    private void addLocales(Enumeration<Locale> locales) {
        while (locales.hasMoreElements()) {
            ...
            this.addLocales(locale);
        }

    }

    private void addLocales(Locale locale) {
        locales.add(locale);
